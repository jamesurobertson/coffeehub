    ...
    <RoastHeaderWrapper>
      <div className="roastheader__header">
        <div className="roastheader__links">
          ...
          /
          <Link
            className="roastheader__link-roast"
            to={`/r/${user.username}/${roastData.name}`}
          >
            {roastData.name}
          </Link>
        </div>
        <div className="roastheader__actions">
          {user.cups.some((cup) => cup.roastId === roastData.id) ? (
            <Button onClick={uncupRoast}>
              <AiOutlineCoffee /> Uncup
            </Button>
          ) : (
            <Button onClick={cupRoast}>
              <AiOutlineCoffee /> Cup
            </Button>
          )}
        </div>
      ...
      <div className="roastheader__nav">
        <NavLink
          exact
          activeclass="active"
          to={`/r/${roastData.user.username}/${roastData.name}`}
        >
          Roast
        </NavLink>
